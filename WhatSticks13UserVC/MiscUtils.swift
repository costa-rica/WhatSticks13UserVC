...
//        userLocationManagerAuthStatus = LocationFetcher.string(for: locationManager.authorizationStatus)
        super.init()
        self.userLocationManagerAuthStatus = "Authorized Always"

    }
    
    func stopMonitoringLocationChanges(){
        print("- LocationFetcher stopMonitoringLocationChanges")
    }
    func startMonitoringLocationChanges(){
        print("- LocationFetcher startMonitoringLocationChanges")
    }
